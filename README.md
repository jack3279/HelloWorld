...
This repository already has **text-to-lottie** installed:

- Cursor skill: `.cursor/skills/text-to-lottie`
- Skills CLI copy: `.agents/skills/text-to-lottie`
- Official Skottie player (this repo)
...
Open `http://localhost:3030`. Then ask the coding agent to generate a Lottie animation using `text-to-lottie`.

To install the skill into another project:
